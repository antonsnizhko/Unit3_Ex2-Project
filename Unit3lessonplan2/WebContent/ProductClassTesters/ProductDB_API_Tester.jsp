...
<% 
	...
	String strProduct = o1.getProduct("ant"); //get the properties of a product object & store in a String 
	out.print("Output from ProductDB_API getProduct(ant) method: <br />" + strProduct); //display the String returned by getProduct( ) method
